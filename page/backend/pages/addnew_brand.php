    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row" style="margin-bottom:50px">
                <div class="col-lg-12">
                    <h1 class="page-header">เพิ่มข้อมูลแบรนด์ใหม่</h1>
                </div>
                <form action="../../../process/backend/save_new_brand.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-lg-12">

                      <div class="form-group required row">
                          <label class="control-label col-md-2">ชื่อแบรนด์</label>
                          <div class="controls col-md-8 ">
                              <input class="form-control" style="margin-bottom: 10px" type="text" name="brand_name" required/>
                          </div>
                      </div>
                    </div>
                  </div>
