...
<html>
  ...
  <body>
    ...
    <section class="hero is-medium is-primary is-bold index-banner">
      <div class="hero-body">
      ...
      <div class="container">
        ...
        <div class="column is-9">
          <div class="container">
            ...
            <div class="columns">
              <?php
                $sql = mysql_query("SELECT * FROM product JOIN brand ON product.brand_id = brand.brand_id where brand.brand_id=22 LIMIT 3");
            ...
            <div class="columns">
              <?php
                $sql = mysql_query("SELECT * FROM product JOIN brand ON product.brand_id = brand.brand_id ORDER BY `product_price` Limit 0,3");
                $num = mysql_num_rows($sql);
                while($user = mysql_fetch_array($sql)){
              ?>
              <div class="column is-3">
