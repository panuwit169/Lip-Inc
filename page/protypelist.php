          ...
          <div class="column is-9">
            <div class="container">
              ...
              <div class="columns is-multiline">
                <?php
                  $sql = mysql_query("SELECT * FROM product JOIN brand ON product.brand_id = brand.brand_id JOIN product_type ON product.protype_id = product_type.protype_id where product_type.protype_id = $id");
